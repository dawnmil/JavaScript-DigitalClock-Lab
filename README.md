...
1. To deploy, right click on the index.html file and select 'Open in Browser'. This needs only to be done once. As you save your changes, simply refresh your browser to see the updated code working in your browser. *Note: Right now, we should only see a blank white window*
